...
- **Results reproducibility** -- if you do the same thing, you should get the same results. This is the essence of the scientific method. If you are unable to reproduce the results, you may not have a full understanding of the underlying causes. 
...
[knitr cache time consuming chunks](https://bookdown.org/yihui/rmarkdown-cookbook/cache.html)
...
- [janitor package](https://sfirke.github.io/janitor/) -- to clean up 
